...
public class SimpleCapabilityProvider<T> implements ICapabilitySerializable<NBTBase> {
     ...
     */
    public SimpleCapabilityProvider(Capability<T> capability, @Nullable EnumFacing facing) {
     ...
     */
    public SimpleCapabilityProvider(Capability<T> capability, @Nullable EnumFacing facing, T instance) {
